...
;
const supabaseServer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseAnonKey, {
    auth: {
...
async function POST(request) {
    try {
        ...
        const { name, email, company, phone, language, address, contactMethod, instagramHandle, productSelections, quantities, logoColor, logoUrl, message } = payload ?? {};
        if (!name || !email) {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from("requests").insert({
            name,
            email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__36fd4a53._.js.map